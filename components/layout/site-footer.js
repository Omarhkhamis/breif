import { Globe, Mail, MessageCircleMore, PhoneCall } from "lucide-react";
import Brand from "../home/brand";
import content from "./site-footer.json";
        ...
        <div className="glass-panel grid gap-10 p-8 lg:grid-cols-[1.15fr_0.7fr_1fr] lg:p-10">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4">
              {content.contacts.map(({ icon, label, value, href, external }) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="truncate text-base font-extrabold text-slate-800" dir="ltr">
                      {value}
                    </span>
                  </a>
                );
